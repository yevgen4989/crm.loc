...
<div class="manager-dashboard-index">
	...
	$("a#deal-delete").on('click',function(e){
		...
		if(keys.length == 0){
		    ...
		    $.post('/site/mass-delete-finally', {keylist : keys}, function(data) {});
		    return false;   
		}
	});
...
JS;
                ...
                'delete' => function ($url, $model, $key) {
                    return Html::a (
                        ...
                        [
                            ...
                            'data-confirm' => 'Вы уверены что хотите удалить сделку окончательно?',
                            'data-method' => 'post',
                        ]
                    );
                },
                ...
                'return' => function($url, $model, $key){
                    return Html::a (
                        ...
                        [
                            ...
                            'class' => 'btn btn-danger btn-xs',
                            'title' => 'Восстановить',
                            'data-confirm' => 'Вы уверены что хотите восстановить сделку?',
                            'data-method' => 'post',
                        ]
                    );
                }
    ...
    $dynaGrid = DynaGrid::begin([
        ...
        'gridOptions' => [
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-trash"></i> Удалить', 'javascript:void(0)', ['data-pjax' => 1, 'class' => 'btn btn-danger', 'title' => 'Delete', 'id'=>'deal-delete',]) .
