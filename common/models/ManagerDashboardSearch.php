 ...
 */
class ManagerDashboardSearch extends ManagerDashboard
{
    ...
    public function search($params)
    {
        ...
        $query = ManagerDashboard::find()->where('status_order_id != 6')->andWhere('status_order_id != 7')->andWhere('status_order_id != 8');
