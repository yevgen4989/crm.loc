 ...
 */
class ManagerDashboardAdminSearch extends ManagerDashboard
{
    ...
    public function search($params)
    {
        ...
        $dataProvider->sort->attributes['status_order_id'] = [
            'default' => SORT_ASC,
            'asc' => ['status_order_id' => SORT_ASC],
            'desc' => ['status_order_id' => SORT_DESC],
        ];
